...
title: "[!DNL Device Co-op] domande frequenti sulla fine del ciclo di vita"
...
# [!DNL Device Co-op] domande frequenti sulla fine del ciclo di vita

Questo documento fornisce le risposte alle domande più frequenti sulle [!DNL Adobe Experience Cloud Device Co-op] piano di fine del ciclo di vita (EOL). Quando questo piano entrerà in vigore, l&#39;Adobe fornirà un avviso avanzato nella [Note sulla versione di Experience Cloud](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html) e [Aggiornamento prioritario del prodotto](https://www.adobe.com/subscription/priority-product-update.html).

[!DNL Device Co-op] è stato un programma che consente ai partecipanti di collaborare per identificare meglio i consumatori in diversi punti di contatto digitali, garantendo al contempo il massimo livello di privacy e trasparenza.
